...
import art.arcane.iris.util.project.stream.arithmetic.AddingStream;
import art.arcane.iris.util.project.stream.arithmetic.ClampedStream;
import art.arcane.iris.util.project.stream.arithmetic.CoordinateBitShiftLeftStream;
import art.arcane.iris.util.project.stream.arithmetic.CoordinateBitShiftRightStream;
import art.arcane.iris.util.project.stream.arithmetic.DividingStream;
import art.arcane.iris.util.project.stream.arithmetic.FittedStream;
import art.arcane.iris.util.project.stream.arithmetic.MaxingStream;
import art.arcane.iris.util.project.stream.arithmetic.MinningStream;
import art.arcane.iris.util.project.stream.arithmetic.ModuloStream;
import art.arcane.iris.util.project.stream.arithmetic.MultiplyingStream;
import art.arcane.iris.util.project.stream.arithmetic.OffsetStream;
import art.arcane.iris.util.project.stream.arithmetic.RadialStream;
import art.arcane.iris.util.project.stream.arithmetic.RoundingDoubleStream;
import art.arcane.iris.util.project.stream.arithmetic.SlopeStream;
import art.arcane.iris.util.project.stream.arithmetic.SubtractingStream;
import art.arcane.iris.util.project.stream.arithmetic.ZoomStream;
import art.arcane.iris.util.project.stream.convert.AwareConversionStream2D;
import art.arcane.iris.util.project.stream.convert.AwareConversionStream3D;
import art.arcane.iris.util.project.stream.convert.CachedConversionStream;
import art.arcane.iris.util.project.stream.convert.ConversionStream;
import art.arcane.iris.util.project.stream.convert.ForceDoubleStream;
import art.arcane.iris.util.project.stream.convert.RoundingStream;
import art.arcane.iris.util.project.stream.convert.SelectionStream;
import art.arcane.iris.util.project.stream.convert.SignificanceStream;
import art.arcane.iris.util.project.stream.convert.To3DStream;
